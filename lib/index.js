...
module.exports = class BroccoliAssetGraph extends Plugin {
  constructor(node, optionsIn) {
    const defaultOptions = {
      ...
      loadAssets: ['**/*'],  // An array of string globs. Defines initial assets to load then search for dependencies
      assetOrder: ['Html', 'JavaScript', 'Json', 'Css', 'Font', 'Jpeg', 'Gif', 'Png', 'Svg', 'Text'],  // Order in which assets are processed. Ordered last to first.
